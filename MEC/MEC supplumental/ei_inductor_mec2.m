function [lambda,c] = ei_inductor_mec2(EI,W,i)
...
for n=1:N
   ...
   [MEC] = mec_nls_branch(MEC, 2, A01,l01,EI.pmub,EI.MP,W.N*i(n),0,[1 -4 6],phib2);
   [MEC] = mec_nl_branch( MEC, 3, A12,l12,EI.pmub,EI.MP,[1 -3 6],phib3);
   [MEC] = mec_lp_branch( MEC, 4, P23,[2 -6]);
   ...
   [MEC] = mec_lp_branch( MEC,13,TPsat,[6]);
