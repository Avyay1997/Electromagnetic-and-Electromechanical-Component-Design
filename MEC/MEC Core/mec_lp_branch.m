function [MEC] = mec_lp_branch(MEC,bn,P,ml)
% mec_lp_branch  Adds a linear permeance branch to the
%                explicit mesh of a magnetic equivalent
%                circuit
%
% [MEC]     = mec_lp_branch(MEC,bn,P,ml)
%
% Inputs:
