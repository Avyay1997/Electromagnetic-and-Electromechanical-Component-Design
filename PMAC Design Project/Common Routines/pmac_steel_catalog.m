function [SP]=pmac_steel_catalog(n)
% pmac_steel_catalog assigns steel parameters to its output structure based
%                    on a code for steel type
%
% Call:
% SP = steel_catalog(n)
%
% Inputs:
% n        = code for steel type
%            n=1       - M19 Steel
%            n=2       - M36 Steel
%            n=3       - M43 Steel
%            n=4       - M47 Steel
...
%
% Outputs:
% SP       = structure of silicon steel parameters 
...
%            (This is point where absolute relative permeability hits 1000)
