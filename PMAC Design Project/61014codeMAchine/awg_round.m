%  FILE:        awg_round.m
%  FUNCTION:    [WP]=awg_round(rw)
%  DESCRIPTION: This routine determines the American Wire Gauge (AWG)
%               closest to the desired wire radius.
%
%  INPUTS:      rw        - desired wire radius (m)
%
%  OUTPUTS:     WP.desc   - wire desription
